...
class fcoin (Exchange):
    ...
    async def fetch_markets(self):
        markets = await self.publicGetPublicSymbols()
        result = []
    ...
    async def cancel_order(self, id, symbol=None, params={}):
        ...
        response = await self.privatePostOrdersIdSubmitCancel(self.extend({
            'id': id,
        }, params))
        return response
    ...
    async def fetch_trades(self, symbol, since=None, limit=None, params={}):
        ...
        response = await self.publicGetMarketTradesSymbol(self.extend(request, params))

        result = self.safe_value(response, "data")

        return self.parse_trades(result, market, since, limit)

    async def fetch_order_book(self, symbol, limit="L20", params={}):
        await self.load_markets()
        market = self.market(symbol)
        ...
        response = await self.publicGetMarketDepthLevelSymbol(self.extend(request, params))
    ...
    async def fetch_ticker(self, symbol, params={}):
        await self.load_markets()
        market = self.market(symbol)
        response = await self.publicGetMarketTickerSymbol(self.extend({
            'symbol': market['id'],
        }, params))
    ...
    def sign(self, path, api='public', method='GET', params={}, headers=None, body=None):
        ...
        if api == 'public':
            ...
            headers['FC-ACCESS-KEY'] = self.apiKey
            headers['FC-ACCESS-SIGNATURE'] = str(signature, encoding = "utf-8")
    ...
    async def fetch2(self, path, api='public', method='GET', params={}, headers=None, body=None):
        ...
        return await self.fetch(request['url'], request['method'], request['headers'], request['body'], request['json'])

    async def fetch(self, url, method='GET', headers=None, body=None, json=None):
        ...
        try:
            async with session_method(yarl.URL(url, encoded=True),
                ...
                self.logger.debug("%s %s, Response: %s", method, url, response.status)
